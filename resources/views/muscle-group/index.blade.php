                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_post" class="post d-flex flex-column-fluid">
                                ...
                                <div id="kt_content_container" class="container-fluid">
                                    ...
                                    <div class="card mb-5 mb-xl-8">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3 mb-1">Grupo Muscular</span>
                                                <span class="text-muted mt-1 fw-bold fs-7">Cadastro de Grupos musculares</span>
                                            </h3>
                                            <div class="card-toolbar">
                                                <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#modal_cadastro">
                                                    ...
                                                    <!--end::Svg Icon-->Nova Grupo muscular
                                                </a>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                                ...
                                                <table id="tabela" class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                                    ...
                                                    <thead>
                                                        <tr class="fw-bolder text-muted bg-secondary">
                                                            <th class="ps-4 min-w-325px rounded-start">Grupos musculares</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr id="tr_{{ $muscleGroup->id }}">
                                                            <td>
                                                                <a href="#" onClick="return abrirModalEditar({{ $muscleGroup->id }});" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6" data-bs-toggle="modal" data-bs-target="#modal_editar">
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <span id="celula_a_{{ $muscleGroup->id }}">{{ $muscleGroup->nome }}</span>
                                                                    </div>
                                                                </a>
                                                            </td>
                                                            <td class="text-end">
                                                                <div class="card-toolbar">
                                                                    <a href="#" class="btn btn-sm btn-light-primary" onClick="return abrirModalEditar('{{ $muscleGroup->id }}');" data-bs-toggle="modal" data-bs-target="#modal_editar">
                                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                                                        <span class="svg-icon svg-icon-2">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                    ...
                                                                    <button type="button" class="btn btn-sm btn-light-danger" onClick="return excluir('{{ $muscleGroup->id }}');">
                                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                                                        <span class="svg-icon svg-icon-2">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <!--end::Tabela-->
                                    @include('muscle-group.criar')
                                    @include('muscle-group.editar')
                                    @include('muscle-group.js')
                                </div>
                            </div>
